...
\end{remark}
\begin{theorem}[First Isomorphism Theorem]\label{thm:1iso}
...
\end{proof}
\begin{theorem}[Correspondence Theorem]\label{thm:cor}
...
\end{proof}
\begin{theorem}[Second Isomorphism Theorem]\label{thm:2iso}
...
\end{proof}
\begin{theorem}[Third Isomorphism Theorem]\label{thm:3iso}
